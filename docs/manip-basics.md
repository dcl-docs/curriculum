...
<small>(Leads to: [Data structure basics](data-structure-basics.md), [Exploratory data analysis (1D)](eda-1d.md), [Other single-table verbs](manip-one-table.md), [Parsing basics](parse-basics.md), [tidycensus](tidycensus.md))</small>
